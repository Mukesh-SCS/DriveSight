...
export const DEFAULT_STATES: StateSummary[] = [
  ...
  { code: "CA", name: "California", questionCount: 112, x: 12, y: 46 },
  { code: "NV", name: "Nevada", questionCount: 45, x: 18, y: 38 },
  { code: "ID", name: "Idaho", questionCount: 12, x: 23, y: 23 },
  ...
  { code: "CO", name: "Colorado", questionCount: 12, x: 37, y: 45 },
  ...
  { code: "GA", name: "Georgia", questionCount: 12, x: 77, y: 75 },
  { code: "FL", name: "Florida", questionCount: 11, x: 80, y: 88 },
  ...
  { code: "CT", name: "Connecticut", questionCount: 12, x: 92, y: 34 },
  { code: "NJ", name: "New Jersey", questionCount: 62, x: 90, y: 40 },
  { code: "DE", name: "Delaware", questionCount: 12, x: 90, y: 48 },
  ...
  { code: "HI", name: "Hawaii", questionCount: 12, x: 27, y: 95 },
];
